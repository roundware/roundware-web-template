...
interface AssetPlayerState {}
class AssetPlayer extends React.Component<AssetPlayerProps, AssetPlayerState> {
	render() {
		...
		return (
			<audio controls style={this.props.style} preload='none' controlsList='nodownload' className={this.props.className}>
