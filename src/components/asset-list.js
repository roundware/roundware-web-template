...
const AssetList = props => {
  const { roundware, selectAsset, selectedAsset, filteredAssets } = useRoundware();
    ...
    <div className="asset-list">
      <div className="asset-list--header">
        <div className='header-controls'>
          <button className={`minimizeButton fa fa-${minimized ? 'expand-alt' : 'compress-alt'}`}
                  onClick={() => set_minimized(!minimized)} />
          <button className="showFiltersButton fa fa-filter"
